...
7. Run `yarn db:setup` to run example migrations and seeds.
8. Run `yarn dev` to start the server in development mode.
9. Navigate to http://localhost:5001/api/exampleResources to verify that the API works and you can read data from the database.
